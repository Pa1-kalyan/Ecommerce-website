package com.application.ecom.mapper;
...
import com.application.ecom.dto.OrderItemDto;
...
import com.application.ecom.entity.OrderItem;
...
public class EntityDtoMapper {
    ...
    public ProductDto mapProductToDtoBasic(Product product) {
        ...
        if (product.getImageUrl() != null) {
            productDto.setImageUrl(awsS3Service.getPresignedUrl(product.getImageUrl()));
        }
